using SAS.Service;
using SAS.Web.Infrastructure.Extensions;
using System;
...
namespace SAS.Web.Infrastructure.MessageHandlers
{
    /// <summary>
    /// 
    /// </summary>
    public class SASAuthHandler:DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
         {
            try
            {
                ...
                if (!string.IsNullOrEmpty(tokens))
                {
                    ...
                    if (membershipCtx.User_Master != null)
                    {
